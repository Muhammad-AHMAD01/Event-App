...
const Button: React.FC<ButtonProps> = ({
  ...
  const dynamicBtnStyle: ViewStyle = {
    ...
    backgroundColor: backgroundColor , // iOS blue
  ...
  const styles = StyleSheet.create({
    ...
    leading: { position: 'absolute', left: 0 } as ViewStyle,
    tailing: { position: 'absolute', right: 0 } as ViewStyle,
    textRow: {
